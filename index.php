...
<head>
    ...
    <title>ApnaGhar-Where Convenience Meets Comfort</title>
...
<body>
  ...
  <div class="container-fluid pg-search-container">
    <div class="row justify-content-center mb-3 text-white">
      <div class="col-auto">
        <h2>&nbsp Where Convenience Meets Comfort</h2>
      </div>
    </div>
    <!-- Search Bar -->
    ...
    <div class="city-box">
      ...
      <div class="city-img">
        <a href="property_list.php?city=Delhi">
          <img src="./img/newdelhi-removebg-preview.png" alt="Delhi">
        </a>
      </div>
      <div class="city-img">
        <a href="property_list.php?city=Mumbai">
          <img src="./img/mumbaii-removebg-preview.png" alt="Mumbai">
        </a>
      </div>
      <div class="city-img">
        <a href="property_list.php?city=Hyderabad">
          <img src="./img/hyderabad-removebg-preview (1).png" alt="Hyderabad">
        </a>
      </div>
      <div class="city-img">
        <a href="property_list.php?city=Bengaluru">
          <img src="./img/bengaluru-removebg-preview.png" alt="Bengaluru">
        </a>
      </div>
